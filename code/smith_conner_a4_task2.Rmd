...
ggplot(data = fish_ts, aes(x = date, y = passage_count)) + 
  ...
  labs(x = "Date", y = "Passage Counts", 
       caption = "Figure 1: Time series fish passage counts for Coho, Jack Coho, and Steelhead at Willamette Falls from 2001 through 2010.") +
...
steel_plot <- fish_ts %>% 
  ...
  labs(title = "Steelhead Passages", y = "Passage Counts",
       caption = "Figure 2: These graphs show the seasonality of passages across the three species. The values in the legend refer to the 10-year range of data with '10' corresponding to 2010.") +
  theme(plot.caption = element_text(hjust = 0, face = "bold.italic")) +
  theme(legend.position = "bottom") +
  theme(axis.title.x = element_blank()) 
...
ggplot(data = fish_counts, aes(x = year, y = annual_count)) +
  ...
  scale_color_manual("Fish Species",
                     values = c('aquamarine4', 'indianred3', 'goldenrod2')) +
  labs(x = "Date", y = "Passage Counts", 
       caption = "Figure 2: Annual fish passage counts for Coho, Jack Coho, and Steelhead at Willamette Falls from 2001 through 2010.") +
   theme(plot.caption = element_text(hjust = 0, face = "bold.italic")) +
  theme(legend.position = "bottom")
