...
The image below shows where the falls are located in the wider watershed.

```{r, out.height="50%", out.width="50%"}
include_graphics(here('watershed_map.png'))
```

[Source: Oregon Department of Fish and Wildlife](https://www.researchgate.net/publication/243963907_Pre-spawning_migration_of_adult_Pacific_lamprey_Entosphenus_tridentatus_in_the_Willamette_River_Oregon_USA)

The following image provides a schematic of the function of the locks, fish ladder, and other infrastructure at the falls.

```{r, out.height="50%", out.width="50%"}
include_graphics(here('falls_locks.jpg'))
```

[Source: U.S. Army Corps of Engineers](https://www.nwp.usace.army.mil/willamette/locks/)
